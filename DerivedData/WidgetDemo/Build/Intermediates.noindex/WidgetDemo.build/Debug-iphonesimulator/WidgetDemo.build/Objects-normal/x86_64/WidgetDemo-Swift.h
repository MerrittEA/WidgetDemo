...
SWIFT_MODULE_NAMESPACE_PUSH("WidgetDemo")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC10WidgetDemo11AppDelegate")
...
SWIFT_CLASS("_TtC10WidgetDemo19QuoteViewController")
...
- (IBAction)newQuoteButtonTapped:(id _Nonnull)sender;
